...
| `Plans/R0.8-MVP/done/design-qa.md` | recorded a `footer Owner/Uptime/Calls` observation | a dated correction line; the measurement itself is not rewritten, because it is what was observed then |
