...
|---|---|
| `docs/06-auth-role.md#bundle` | [owner](../../R1.0-Release/auth.md#bundle) |
| `docs/06-auth-role.md#where-it-runs` | [owner](../../R1.0-Release/auth.md#where-it-runs) |
| `docs/06-auth-role.md#topology` | [owner](../../R1.0-Release/auth.md#topology) |
| `docs/06-auth-role.md#reference-deployment` | [owner](../../R1.0-Release/auth.md#reference-deployment) |
| `docs/06-auth-role.md#consistency-window` | [owner](../../R1.0-Release/auth.md#consistency-window) |
| `docs/06-auth-role.md#ssh-admin` | [owner](../../R1.0-Release/auth.md#ssh-admin) |
| `docs/01-identity.md#groups-and-roles` | [owner](../../R1.0-Release/identity.md#groups-and-roles) |
| `docs/01-identity.md#sigils` | [owner](../../R1.0-Release/identity.md#sigils) |
| `docs/01-identity.md#delegation` | [owner](../../R1.0-Release/identity.md#delegation) |
| `docs/01-identity.md#resolved-at-login` | [owner](../../R1.0-Release/identity.md#resolved-at-login) |
| `docs/01-identity.md#ownership` | [owner](../../R1.0-Release/identity.md#ownership) |
| `docs/01-identity.md#sealed-private-config` | [owner](../../R1.0-Release/identity.md#sealed-private-config) |
| `docs/02-access.md#token-scope` | [owner](../../R1.0-Release/access.md#token-scope) |
| `docs/02-access.md#key-modes` | [owner](../../R1.0-Release/access.md#key-modes) |
| `docs/02-access.md#encrypted-sessions` | [owner](../../R1.0-Release/access.md#encrypted-sessions) |
| `docs/02-access.md#key-confirmation` | [owner](../../R1.0-Release/access.md#key-confirmation) |
...
| `docs/10-modules.md#modules` | [owner](../../R1.0-Release/modules.md#modules) |
| `docs/10-modules.md#the-hot-path` | [owner](../../R1.0-Release/modules.md#the-hot-path) |
| `docs/10-modules.md#what-this-buys` | [owner](../../R1.0-Release/modules.md#what-this-buys) |
| `docs/12-stages.md#poc` | owner (PoC plan, removed 2026-09-18) |
| `docs/12-stages.md#r1` | [owner](../../R1.0-Release/README.md#scope) |
| `docs/12-stages.md#r11` | [owner](../../R1.1/README.md#scope) |
| `Plans/R0.8-MVP/TODO.md#d--the-bus-stops-reading-payloads` | [owner](../../R1.0-Release/encryption-wave.md#d--the-bus-stops-reading-payloads) |
...
| D27 | [owner](../../R1.0-Release/identity.md#sigils) |
| D28 | [owner](../../R1.0-Release/identity.md#sigils) |
| D29 | [owner](../../R1.0-Release/identity.md#sigils) |
| D30 | [owner](../../R1.0-Release/identity.md#sigils) |
| D31 | [owner](../../../docs/05-discovery.md#audience) |
| D32 | [owner](../../../docs/02-access.md#trust-boundary) |
| D33 | [owner](../../../docs/02-access.md#proving-possession) |
| D34 | [owner](../../../docs/02-access.md#proving-possession) |
| D35 | [owner](../../../docs/02-access.md#proving-possession) |
...
| D45 | [owner](../../../docs/02-access.md#what-a-call-carries) |
| D46 | [owner](../../R1.0-Release/access.md#token-scope) |
...
| D58 | [owner](../../R1.0-Release/access.md#key-modes) |
| D59 | [owner](../../R1.0-Release/access.md#encrypted-sessions) |
| D60 | [owner](../../R1.0-Release/access.md#encrypted-sessions) |
| D61 | [owner](../../R1.0-Release/runner.md#additional-script-forms) |
| D62 | [owner](../../R1.1/access.md#service-to-service) |
| D63 | [owner](../../R1.0-Release/access.md#key-confirmation) |
...
| D72 | [owner](../../../docs/03-records.md#configuring-a-template) |
| D73 | [owner](../../../docs/03-records.md#configuring-a-template) |
| D74 | [owner](../../../docs/03-records.md#configuring-a-template) |
...
| D88 | [owner](../../R2.0-Future/storage.md#storage) |
...
| D121 | [owner](../../R1.0-Release/runner.md#additional-script-forms) |
| D122 | [owner](../../R1.0-Release/runner.md#long-lived-services) |
...
| D133 | [owner](../../R1.0-Release/identity.md#ownership) |
| D134 | [owner](../../R1.0-Release/identity.md#ownership) |
| D135 | [owner](../../R1.0-Release/identity.md#ownership) |
| D136 | [owner](../../R1.0-Release/runner.md#backing-it-up) |
| D137 | [owner](../../R1.0-Release/runner.md#backing-it-up) |
| D138 | [owner](../../R1.0-Release/runner.md#the-list-of-what-is-installed) |
| D139 | [owner](../../R1.0-Release/runner.md#the-list-of-what-is-installed) |
| D140 | [owner](../../R1.0-Release/runner.md#the-list-of-what-is-installed) |
| D141 | [owner](../../R1.0-Release/runner.md#what-it-comes-after) |
| D142 | [owner](../../R1.0-Release/runner.md#what-it-comes-after) |
| D143 | [owner](../../R1.0-Release/runner.md#what-it-comes-after) |
| D144 | [owner](../../R1.0-Release/runner.md#backing-it-up) |
...
| D171 | [owner](../../R2.0-Future/billing.md#billing-role--future) |
...
| D184 | [owner](../../../docs/03-records.md#configuring-a-template) |
| D185 | [owner](../../../docs/04-messaging.md#inbox-queues) |
| D186 | [owner](../../../docs/03-records.md#how-to-call-it) |
...
| D199 | [owner](../../R1.0-Release/operations.md#runner-unit) |
| D200 | [owner](../../R1.0-Release/operations.md#runner-unit) |
| D201 | [owner](../../R1.0-Release/operations.md#runner-unit) |
| D202 | [owner](../../R1.0-Release/runner.md#what-an-instance-is) |
| D203 | [owner](../../R1.0-Release/runner.md#the-three-env-layers) |
| D204 | [owner](../../R1.0-Release/runner.md#the-three-env-layers) |
| D205 | [owner](../../R1.0-Release/runner.md#what-the-child-is-told) |
| D206 | [owner](../../R1.0-Release/runner.md#what-the-child-is-told) |
| D207 | [owner](../../R1.0-Release/runner.md#what-an-instance-is) |
| D208 | [owner](../../R1.0-Release/runner.md#reaching-the-runner) |
| D209 | [owner](../../R1.0-Release/runner.md#where-it-runs) |
| D210 | [owner](../../R1.0-Release/runner.md#what-an-instance-is) |
...
| D219 | [owner](../../R2.0-Future/FUTURE.md#candidates) |
...
| D243 | [owner](../../R1.0-Release/discovery.md#dashboard-extensions) |
...
[R1 decisions](../../R1.0-Release/DECISIONS.md#backup-encryption-choice).
