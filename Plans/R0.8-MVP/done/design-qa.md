...
- Selected visual direction: `Plans/R0.8-MVP/web-handoff/img/services-option-2.png`
- Selected content direction: Option 1 in `Plans/R0.8-MVP/web-handoff/visual-options.md`
