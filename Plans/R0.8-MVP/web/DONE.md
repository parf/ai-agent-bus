...
| W.12 | Installed real-browser gate: `src/acceptance/installed-browser.sh` installs the package with sample data on a networked real-systemd container, and Chromium walks the face (0.8.53); the fresh and upgrade container gates re-ran against it on 0.8.51 | passed on 0.8.53; a corrupted CDN integrity hash fails "no Lucide icon was drawn", a 800 px body fails "/ scrolls sideways by 410px at 390px" | — |
