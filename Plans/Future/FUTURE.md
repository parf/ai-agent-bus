...
| Per-call authority cache | A measured need: 0.7's liveness and ownership checks cost lookup and list ~0.2 µs per record ([0.7 compared](../MVP/0.7-baseline.md#07-compared-k17)); any cache must be invalidated by every commit and never let a revoked or deactivated principal act on a stale answer |
