...
| Channels and subscriptions | Built: [topics](../../docs/03-records.md#topics), [subscribers](../../docs/04-messaging.md#subscribers) | Display the record's kind and visible relationships |
