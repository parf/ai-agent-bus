...
<div class=detail-meta><span class=fact-pill>👤 User</span><span class=fact-pill>{{authorityLabel .DaemonOwner .Administrator}}</span><span class=fact-pill>{{.Status}}</span></div>
