...
const (
	...
	// reason the default is no glyph (Plans/R0.8-MVP/web-handoff/glyphs.md#the-rule-that-matters-most).
	DaemonOwnerGlyph = "🔱"
	MaintainerGlyph  = "👮"
)
...
// (Plans/R0.8-MVP/web-handoff/glyphs.md#the-rule-that-matters-most). The cell still carries
