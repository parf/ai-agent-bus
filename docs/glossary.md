...
| Personal service | Owner-tagged service classification; stored limits are built and web grouping is pending | [definition](03-services-and-topics.md#personal-and-shared) |
