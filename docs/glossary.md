...
| **`GithubUser`** | the GitHub login on a record, equal to the username when the record came from GitHub; a hint until proving one is built, after R1.1 | [identity § registration](01-identity.md#registration) |
