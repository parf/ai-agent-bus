...
that boundary. The [installed checks](../Plans/R0.8-MVP/done/installed-shared-host.md#checks)
...
[Web § process and account](../Plans/R0.8-MVP/web/README.md#process-and-account).
