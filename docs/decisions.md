...
| An agent's record is labelled `👾` | [identity labels](05-discovery.md#identity-labels-in-web-and-cli) | 2026-09-18 owner decision, resolving Q76; supersedes the `📥 Inbox` label of 0.5.84 while the channels placement that decision also made stands. Built in 0.6.1 |
...
| A service is external; what runs on this bus is an agent | [five record kinds](03-services-and-topics.md#five-record-kinds), [how to call it](03-services-and-topics.md#how-to-call-it) | 2026-09-18 owner decision; a `service` requires an address and a protocol, `register` defaults to it, and a started script registers as an agent |
| Personal is a flag on an agent, not a kind | [personal and shared](03-services-and-topics.md#personal-and-shared) | 2026-09-18 owner decision; the existing `Personal` field stays, and its generic-only rule becomes agent-only |
| A service holds secrets, separately from its configuration | [service secrets](03-services-and-topics.md#service-secrets) | 2026-09-18 owner decision; brought forward from R1.1. Same shape as configuration, different mechanics at every other point; the record's ACL admits readers |
| No compatibility obligation before 1.1 | [five record kinds](03-services-and-topics.md#five-record-kinds) | 2026-09-18 owner decision; stored state is re-registered rather than migrated, and a snapshot of an older shape need not be readable |
...
| Personal ACLs exclude groups | [Personal assignment limits](03-services-and-topics.md#personal-and-shared) | 2026-09-17 owner clarification; resolves Q71, including groups composed only of services; enforced in 0.5.50 |
...
| One reader count includes filtered waits | [reader observation](05-discovery.md#readers) | 2026-09-17 owner decision; resolves Q70, implemented in 0.5.53 |
| Explicit inbox selection, independent message filters | [consume syntax](04-messaging.md#inbox-selection-and-filters) | 2026-09-17 owner decision; resolves Q21, implemented in 0.5.52 |
...
| 2026-09-16 | The dashboard is authored in `templ`; resolves Q60 | A component whose mandatory arguments are declared makes structural obligations compile errors rather than discipline. The guarantee comes from the component API, not the tool; `templ` renders server-side and is independent of the later bounded selector-submit behavior | [rendering](../Plans/MVP/web/technology.md#rendering) |
...
| No browser JavaScript (2026-09-16, resolving Q58) | [One local selector-submit behavior](05-discovery.md#rules-it-is-built-to) — owner instruction on 2026-09-18; no enhancement layer or external script was introduced |
