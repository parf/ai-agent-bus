...
| 2026-09-15 | A service owned by a paused or banned user refuses calls, in the daemon; opens Q55 | The state is about what that person's names may do, and a page that labelled the owner while the service still answered would describe a rule nobody applied; it deletes nothing and kills nothing, or a ban could not be lifted | [services of a user who is paused or banned](01-identity.md#services-of-a-user-who-is-paused-or-banned) |
