...
| Entity labels in web and CLI | [display labels](05-discovery.md#identity-labels-in-web-and-cli) | 2026-09-16 owner-selected glyphs for web and human-readable CLI output; implemented in 0.5.54 from daemon-stated kinds, with compact WEB name prefixes and Group added in 0.5.60; plain machine values retained |
