...
| 2026-09-17 | Service lists distinguish Yours and Personal, use one detail link and compact update time | Owner instruction; ownership and classification remain separate returned facts, and list density removes the duplicate Edit route without moving authority into the face | [section navigation](05-discovery.md#section-navigation-and-registration) |
